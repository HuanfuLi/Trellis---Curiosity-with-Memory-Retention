...
- **Global scope**: `/Users/Code/EchoLearn/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Code/EchoLearn/.codex/notes/`)
...
2. Glob `/Users/Code/EchoLearn/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Code/EchoLearn/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Code/EchoLearn/.codex/notes/` — works in any directory
