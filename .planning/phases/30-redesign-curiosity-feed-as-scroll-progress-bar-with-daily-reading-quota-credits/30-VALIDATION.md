...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 30-01-01 | 01 | 1 | D-07/D-08 | unit | `cd app && node --test tests/services/reading-progress.test.mjs` | ❌ W0 | ⬜ pending |
...
- [ ] `app/tests/services/reading-progress.test.mjs` — stubs for reading detection + localStorage persistence
...
| Hidden bar when no posts | D-13/D-14 | Conditional rendering | Clear post cache, reload, verify no progress bar |
