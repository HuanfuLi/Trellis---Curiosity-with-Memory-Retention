...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <verify>
    <automated>rg -n "\\| locale-switch \\|.*\\| (pass|fail) \\||\\| ask-streaming \\|.*\\| (pass|fail) \\||\\| queue-refill \\|.*\\| (pass|fail) \\||\\| saved-route-navigation \\|.*\\| (pass|fail) \\||\\| android-sync-sanity \\|.*\\| (pass|fail) \\|" .planning/phases/44-dependency-version-sweep/44-UAT.md</automated>
  </verify>
  <acceptance_criteria>
